...
/*
	...
	Name: /home/index.php
	Purpose: Home page to administer site
	Revision: 1
...
*/
	...
	$message = '<div id="homeMessage">' . "\n\t";
	$message .= '<p id="homeMessageImg"><img src="/spark/images/errorCross.png" alt="error" /></p>' . "\n\t";
	$message .= '<p id="homeMessageTxt">You do not have access to view this page.<br /></p>' . "\n\t";
	$message .= '</div>' . "\n";
...
<style type="text/css">
	<!--
		...
		@import url("/spark/styles/home.css");		
	-->
</style>
